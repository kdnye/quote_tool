...
def quote_ui():
    ...
    with col1:
        ...
        pieces = st.number_input("Number of Pieces", min_value=1, value=1)
        ...
        # dim factor consistent with your prior version (250)
        dim_weight = (length * width * height) / 250
    ...
    if st.button("Generate Quote"):
        ...
        db.add(quote_row)
        db.commit()
        # quote_id is generated by the model default; fetch it after commit
